# skywatch-coordinator__016 Docker 交付说明
...
```bash
./build_benzhi_docker.sh skywatch-coordinator__016-benzhi linux/amd64
docker run --rm -it skywatch-coordinator__016-benzhi bash
```
