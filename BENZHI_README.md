# skywatch-coordinator-1393 Docker 交付说明
...
```bash
./build_benzhi_docker.sh skywatch-coordinator-1393-benzhi linux/amd64
docker run --rm -it skywatch-coordinator-1393-benzhi bash
```
