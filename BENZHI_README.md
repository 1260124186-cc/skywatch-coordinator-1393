# skywatch-coordinator__007 Docker 交付说明
...
```bash
./build_benzhi_docker.sh skywatch-coordinator__007-benzhi linux/amd64
docker run --rm -it skywatch-coordinator__007-benzhi bash
```
