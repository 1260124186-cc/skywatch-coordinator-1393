# skywatch-coordinator__006 Docker 交付说明
...
```bash
./build_benzhi_docker.sh skywatch-coordinator__006-benzhi linux/amd64
docker run --rm -it skywatch-coordinator__006-benzhi bash
```
