# skywatch-coordinator__015 Docker 交付说明
...
```bash
./build_benzhi_docker.sh skywatch-coordinator__015-benzhi linux/amd64
docker run --rm -it skywatch-coordinator__015-benzhi bash
```
